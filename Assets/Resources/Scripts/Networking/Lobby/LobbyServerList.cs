    ...
    public class LobbyServerList : MonoBehaviour
    {
		...
		public void OnGUIMatchList(bool success, string extendedInfo, List<MatchInfoSnapshot> matches)
		{
			...
			for (int i = 0; i < matches.Count; ++i)
			{
				...
				o.GetComponent<LobbyServerEntry>().Populate(matches[i], LobbyManager.singleton, (i % 2 == 0) ? OddServerColor : EvenServerColor);
        ...
        public void RequestPage(int page)
        {
            ...
            currentPage = page;
			LobbyManager.singleton.matchMaker.ListMatches(page, 6, "", true, 0, 0, OnGUIMatchList);
		}
    }
}